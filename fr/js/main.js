...
jQuery(function($) {
	...
	$('.unfold').click(function () {
		if(open === false) {
			...
			$('#footer #title_footer').html("Vous avez <span class='bold'>terminé</span> ?");
			$('#contact-pigeon p').html("Cliquer sur moins pour fermer.");
			$('#contact-pigeon p').css('font-size', '1.0em');
			...
			$('#footer #title_footer').html("Me <span class='bold'>contacter</span> ?");
			$('#contact-pigeon p').html("Ne vous inquietez pas, c'est très simple.<br />Vous n'avez qu'à cliquer sur le bouton plus.");
